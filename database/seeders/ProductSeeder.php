...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            ...
            'stock'     => 20,
            'price'     => 500.00,
            'description' => "Descarga y juega más de 100 juegos de alta calidad, incluidos todos los títulos nuevos de Xbox Game Studios como Halo Infinite el mismo día de su lanzamiento, con Xbox Game Pass Ultimate (la membresía se vende por separado). Xbox Entrega inteligente garantiza que juegues la mejor versión disponible de tu juego sin importar en qué consola estés jugando. En tu tienda en línea conoce lo fácil que es comprar sin salir de casa. Da clic y adquiere tus videojuegos favoritos.",
            'category_id' => "006fe0af-379f-47cd-bb0f-769fadd2ac36",
            'created_at' => Carbon::now(),
            'updated_at' => Carbon::now()
        ]);
